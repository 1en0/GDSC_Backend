...
(
    id         bigint auto_increment comment 'auto increment id, primary key, unique id each elder'
        primary key,
    user_id    varchar(255)         not null comment 'owner of the house',
...
(
    id        bigint auto_increment comment 'auto increment id, primary key, unique id for each record' primary key,
...
(
    ...
    user_id   varchar(255)         null comment 'owner of this room',
